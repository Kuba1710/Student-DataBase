...
namespace StudentDataBase {
	...
	// gettery potrzebne do plikow formsowych
	public: System::Windows::Forms::DataGridView^ getDataGrid()
	{
		return dataGridView1;
	}

	public: System::Windows::Forms::TextBox^ getsearchTextBox()
	{
		return searchTextBox;
	}

	public: System::Windows::Forms::ComboBox^ getCombo()
	{
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// FirstNameTB
			// 
			this->FirstNameTB->Location = System::Drawing::Point(22, 50);
			this->FirstNameTB->Name = L"FirstNameTB";
			this->FirstNameTB->Size = System::Drawing::Size(71, 20);
			this->FirstNameTB->TabIndex = 2;
			this->FirstNameTB->Text = L"FirstName";
			// 
			// SecondNameTB
			// 
			this->SecondNameTB->Location = System::Drawing::Point(156, 50);
			this->SecondNameTB->Name = L"SecondNameTB";
			this->SecondNameTB->Size = System::Drawing::Size(71, 20);
			this->SecondNameTB->TabIndex = 3;
			this->SecondNameTB->Text = L"Secondname";
			// 
			// degreeTB
			// 
			this->degreeTB->Location = System::Drawing::Point(788, 50);
			this->degreeTB->Name = L"degreeTB";
			this->degreeTB->Size = System::Drawing::Size(71, 20);
			this->degreeTB->TabIndex = 4;
			this->degreeTB->Text = L"degree";
			// 
			// yearOfStudyTB
			// 
			this->yearOfStudyTB->Location = System::Drawing::Point(1007, 50);
			this->yearOfStudyTB->Name = L"yearOfStudyTB";
			this->yearOfStudyTB->Size = System::Drawing::Size(71, 20);
			this->yearOfStudyTB->TabIndex = 5;
			this->yearOfStudyTB->Text = L"yearOfStudy";
			// 
			// gpaTB
			// 
			this->gpaTB->ForeColor = System::Drawing::SystemColors::MenuHighlight;
			this->gpaTB->Location = System::Drawing::Point(1128, 50);
			this->gpaTB->Name = L"gpaTB";
			this->gpaTB->ReadOnly = true;
			this->gpaTB->Size = System::Drawing::Size(71, 20);
			this->gpaTB->TabIndex = 6;
			this->gpaTB->Text = L"GPA";
			// 
			// IndexTB
			// 
			this->IndexTB->Location = System::Drawing::Point(286, 50);
			this->IndexTB->Name = L"IndexTB";
			this->IndexTB->Size = System::Drawing::Size(71, 20);
			this->IndexTB->TabIndex = 7;
			this->IndexTB->Text = L"index";
			// 
			// FieldOfStudyTB
			// 
			this->FieldOfStudyTB->Location = System::Drawing::Point(530, 50);
			this->FieldOfStudyTB->Name = L"FieldOfStudyTB";
			this->FieldOfStudyTB->Size = System::Drawing::Size(71, 20);
			this->FieldOfStudyTB->TabIndex = 8;
			this->FieldOfStudyTB->Text = L"FieldOfStudy";
			// 
			// ectsTB
			// 
			this->ectsTB->BackColor = System::Drawing::SystemColors::Control;
			this->ectsTB->ForeColor = System::Drawing::Color::Red;
			this->ectsTB->Location = System::Drawing::Point(907, 50);
			this->ectsTB->Name = L"ectsTB";
			this->ectsTB->ReadOnly = true;
			this->ectsTB->Size = System::Drawing::Size(71, 20);
			this->ectsTB->TabIndex = 9;
			this->ectsTB->Text = L"ECTS";
			// 
			// peselTB
			// 
			this->peselTB->Location = System::Drawing::Point(422, 50);
			this->peselTB->Margin = System::Windows::Forms::Padding(2);
			this->peselTB->Name = L"peselTB";
			this->peselTB->Size = System::Drawing::Size(71, 20);
			this->peselTB->TabIndex = 10;
			this->peselTB->Text = L"pesel";
			// 
			// specializationTB
			// 
			this->specializationTB->Location = System::Drawing::Point(660, 50);
			this->specializationTB->Margin = System::Windows::Forms::Padding(2);
			this->specializationTB->Name = L"specializationTB";
			this->specializationTB->Size = System::Drawing::Size(71, 20);
			...
			this->label5->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 9.75F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(238)));
			this->label5->Location = System::Drawing::Point(785, 19);
			...
			this->label7->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 9.75F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(238)));
			this->label7->Location = System::Drawing::Point(1004, 19);
			...
			this->groupComboBox->Location = System::Drawing::Point(869, 178);
			...
			// groupButton
			// 
			this->groupButton->Location = System::Drawing::Point(869, 122);
			...
			this->iefCoursesButton->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 9.75F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(238)));
			this->iefCoursesButton->Location = System::Drawing::Point(1099, 168);
			this->iefCoursesButton->Name = L"iefCoursesButton";
			this->iefCoursesButton->Size = System::Drawing::Size(100, 41);
			...
			this->Controls->Add(this->iefCoursesButton);
			this->Controls->Add(this->EcCoursesButton);
...
{ 
	...
	//students->connectToDataBase(sqlConn, sqlCmd, sqlDt, sqlDta, sqlRd);
	EC_courses^ ecCourses = gcnew EC_courses(dataGridView1, searchTextBox, groupComboBox, student, IndexTB);
	IEF_courses^ iefCourses = gcnew IEF_courses();

	if (specializationTB->Text == "EC")
	{
		ecCourses->Show();
	}
	else
